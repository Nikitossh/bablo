...
import static com.gmail.nikitko1988.persistent.Queries.selectTotalAndAngWholeYear;
import static com.gmail.nikitko1988.persistent.Queries.selectTotalAndAvgYearByCategory;
...
public class DAO {
    ...
    public static ResultSet selectionTotalAndAvgYear() {
        String sql = selectTotalAndAvgYearByCategory();
        ResultSet rs= executePreparedStatement(createPreparedStatement(sql));
        return rs;
    }

    public static ResultSet selectionTotalAndAngWholeYear() {
        String sql = selectTotalAndAngWholeYear();
        ResultSet rs = executePreparedStatement(createPreparedStatement(sql));
        return rs;
    }
